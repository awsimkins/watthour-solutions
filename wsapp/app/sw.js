/* WSApp offline cache — active only when served over http/https (not file://) */
const WSAPP_CACHE = 'wsapp-v1.7.1-inline';
const CACHE_URLS = [
  './',
  './index.html',
  '../index.html',
...
self.addEventListener('fetch', function(event) {
  ...
  /* Map tiles: network-first so hotspot / SIM loads fresh tiles when online */
  ...
  /* App shell: cache-first — works offline; origin must stay on the iPad (127.0.0.1), not a PC IP */
  event.respondWith(
