...
House copy of this repo:

`\\ws_server\Watthour_Solutions\watthoursolutions_website`

Client portal chrome (not GitHub Pages):

`\\ws_server\Watthour_Solutions\watthoursolutions_website\vault`

Published pictures and test reports (backup only):
...
1. Edit files on `\\ws_server\Watthour_Solutions\watthoursolutions_website`.
